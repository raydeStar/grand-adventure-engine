...
## 2. Potions Are Narrator-Driven (No Mechanical "Use" Command)
...
**What's needed:**
- Option A: Auto-equip on take if the slot is empty and the item is equippable
...
|-----|--------|--------|----------|
| Mechanical potion use | Small | High (combat reliability) | **P1** |
| Multi-enemy combat | Large | High (immersion) | **P2** |
| Buy/sell system | Medium | Medium (economy) | **P3** |
| Auto-equip on take | Small | Low (QoL) | **P4** |
